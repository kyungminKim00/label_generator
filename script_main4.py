...
app.layout = html.Div([
    ...
    html.Div(id='actions-div', style={'display':'none'}, children='[]')  # 초기 값을 '[]'로 설정합니다.
])
...
def update_step(n_forward, n_backward, n_buy, n):
    print(f"update_step: {n_forward, n_backward, n_buy, n}")
...
def update_actions(n_buy, n, actions):
